...
export class ConversationService {
    ...
    routes={
        startConversationPath:(payload:any)=>`${environment.baseUrl}/conversation?id=${payload}`,
  ...
  startCono(id:any,payload:any){
    return this.http.put(this.routes.startConversationPath(id),payload,{responseType:'arraybuffer'}
      )
  }
